...
- bd issue 文脈がある場合: 背景、問題、選択肢、重要な問答、レビュー、推奨を issue notes/comment に要約して残す。最終案だけでなく、判断を変えた探索過程も保存する。
...
8. bd issue 文脈がある場合は、`Background / Problem / Options / Q&A / Review / Recommendation` を issue notes/comment に追記する。
9. ユーザーにティア選択 or 制約更新を求める。
10. Insights Summary で閉じる。
