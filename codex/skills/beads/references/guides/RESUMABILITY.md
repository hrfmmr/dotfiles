...
**The test:** Would a fresh Codex instance (or you after 2 weeks) struggle to resume this work from the description alone? If yes, add implementation details.
...
**Problem:** Future Codex doesn't know:
...
**Result:** Fresh Codex instance can:
...
**The principle:** Help your future self (or next Codex) resume without rediscovering everything.
