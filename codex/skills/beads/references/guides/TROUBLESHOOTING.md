...
**If using MCP server integration:**
```bash
# Upgrade Codex CLI and beads CLI
# Codex CLI: use your package manager or installer
# beads CLI: follow beads install/upgrade instructions
```
...
### Codex CLI Skill Issues

If the **beads skill** provides incorrect guidance:

1. **Check skill version:**
   ```bash
   ls -la ~/.codex/skills/beads/
   head -20 ~/.codex/skills/beads/SKILL.md
   ```

2. **Report via Codex CLI feedback** or user's GitHub
