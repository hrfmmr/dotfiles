# Beads Skill for Codex CLI

A comprehensive skill for using [beads](https://github.com/steveyegge/beads) (bd) issue tracking with Codex CLI.

## What This Skill Does

This skill teaches Codex CLI how to use bd effectively for:
...
Copy the `beads/` directory to your Codex CLI skills location:
...
├── CODEX.md                # Maintenance guide for updating the skill
...
When Codex's context gets compacted, conversation history is lost but bd state survives. Write notes as if explaining to a future Codex with zero context:
...
This skill is maintained at [github.com/steveyegge/beads](https://github.com/steveyegge/beads) in the `legacy-plugin-snapshot/skills/beads/` directory.
