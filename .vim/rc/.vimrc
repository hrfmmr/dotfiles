...
augroup IndentGroup
  ...
  au BufNewFile,BufRead *.{json,xml,html,toml,yaml,yml,tf} setlocal ts=2 sts=2 sw=2
  au BufNewFile,BufRead *.{sql} setlocal ts=2 sts=2 sw=2
  au BufNewFile,BufRead *.{css,scss} setlocal ts=2 sts=2 sw=2
  au BufNewFile,BufRead *.{vim} setlocal ts=2 sts=2 sw=2
